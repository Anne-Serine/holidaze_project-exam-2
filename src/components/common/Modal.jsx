...
function Modal({ dialogRef, venueNameToDelete, closeModal, confirmDelete, successMessage }) {
  return (
    <dialog
      ref={dialogRef}
    ...
    >
      {successMessage ? (
        <p className="flex flex-col gap-4 text-center items-center"><Check color="green" size={30} />{successMessage}</p>
      ) : (
        <>
